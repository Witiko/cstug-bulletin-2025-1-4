...
Inštalácia tretej verzie balíka sa výrazne zjednodušila. Balík obsahuje \LaTeX ové makrá, samotný spustiteľný súbor \texttt{latexminted} a všetky potrebné pythonové knižnice (vrátane Pygments). Používateľ tak nemusí inštalovať Python ani Pygments samostatne, ani upravovať systémovú premennú PATH. Inštalácia je teda rovnaká ako pri bežných \LaTeX ových balíkoch~\cite[sekcia~3]{mintedv3}.
