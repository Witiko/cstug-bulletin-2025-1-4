...
\makeatletter
  \bul@rr@toks{%
    Redakční rada:        & Vít Starý Novotný (šéfredaktor), Jan Šustek, \\
                          & Zdeněk Wagner a Zbyněk Michálek (korektura) \\
...
\PDFclanek[hoftich-tex4ht]{hoftich-article}
\PDFclanek[slamova-context]{main}
\PDFclanek[hitzinger-games]{TeXGames}
\PDFclanek[blaho-sadzba]{dokument}
